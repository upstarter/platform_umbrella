export const quiz = {
  ...
  "questions": [{
      ...
      "questionType": "text",
      "answers": [
        "A piece of paper with your secret/private key on it",
        "A one time use wallet",
    ...
    {
      "question": "Which tokens will capture the most market value? Select all that apply.",
      "questionType": "text",
      "answers": [
    ...
    {
      "question": "Which of the following is a crypto-economic primitive?",
      "questionType": "text",
      "answers": [
        "State Channels",
        "Zk-Snarks",
